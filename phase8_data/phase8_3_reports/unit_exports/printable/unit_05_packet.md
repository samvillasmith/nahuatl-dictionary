...
## Overview
- communicative goal: State and ask about occupations and basic social roles.
- grammar focus: Core lesson constructions and reusable sentence patterns.
- theme focus: The Professions
- output task: Produce a short descriptive or transactional exchange built around The Professions.
...
- Xōchipitzāhuatl Instrumental con El Tr o Colatl n del T o Laco
...
## Dialogue set
- A: Piyali Catalina, ¿tlen titequiti ta?
- B: Nitlamachtia nāhuatl.

## Review items
- Recall five Unit 5 vocabulary items.
- Complete one missing line from a Unit 5 dialogue.
- Transform a sentence using a Unit 5 construction.